...
(function(window, undefined) {
  var dirruns, cachedruns, assertGetIdNotName, Expr, getText, isXML, contains, compile, sortOrder, hasDuplicate, baseHasDuplicate = true,
  ...
  function tokenize(selector, context, xml, parseOnly) {
    var matched, match, tokens, type, soFar, groups, group, i, preFilters, filters, checkContext = !xml && context !== document,
  ...
  function handlePOS(groups, context, results, seed) {
    var group, part, j, groupLen, token, selector, anchor, elements, match, matched, lastIndex, currentContexts, not, i = 0,
      len = groups.length,
      rpos = matchExpr["POS"],
  ...
  function select(selector, context, results, seed, xml) {
    ...
    var elements, matcher, cached, elem, i, tokens, token, lastToken, findContext, type, match = tokenize(selector, context, xml),
      ...
      select = function(selector, context, results, seed, xml) {
        if (!seed && !xml && (!rbuggyQSA || !rbuggyQSA.test(selector))) {
          if (context.nodeType === 9) {
            ...
            var groups, i, len, old = context.getAttribute("id"),
              nid = old || expando,
...
(function() {
  ...
  var r, t, u, x, z, B, C, D, E, F, G, H, I, J = new Date(-0xc782b5b800cec),
    K, O, P;
  try {
  ...
  d3_transitionPrototype.style = function(name, value, priority) {
    ...
    return d3_transition_tween(this, "style." + name, value, function(b) {
      function styleString() {
        if (this.raphaelNode) {
          var a = this.getCurrentStyle()[name],
            i;
          return a !== b && (i = interpolate(a, b), function(t) {
